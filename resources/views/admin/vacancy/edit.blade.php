                    ...
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('vacancy.update', $vacancy['id']) }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <textarea name="VacancyDescription"  rows="6" class="form-control">{{ $vacancy['VacancyDescription'] }}</textarea>
                                </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">Сохранить и одобрить</button>
                            </div>
                        </form>
                    </div>
                </div>
